...
def init_all_databases():
    """Initialize all databases at startup using the new modular system."""
    # Use the new modular database manager instead of individual functions
    # to avoid schema conflicts with the new system
    from src.database.db_manager import db_manager
    db_manager.initialize_all_databases()
    print("✅ All Phase 1 databases initialized with new modular system")
